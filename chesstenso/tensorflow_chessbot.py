...
import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3' # Ignore Tensorflow INFO debug messages
...
def main(img, active="w", unflip=False):
  # Load image from filepath or URL
    # Load image from file
  img = helper_image_loading.loadImageFromPath(img)
  # else:
  ...
  active = active
  return "%s %s - - 0 1" % (short_fen, active), certainty * 100
